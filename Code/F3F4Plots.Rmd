...
```{r,map plot}
LatLong<-read.csv("../Data/LatLongwID.csv")
...
```{r read files}
prefix<-"../Data/genotypes.50k.850k.wild.NoHybrids.NoK4"
...
graph1 <- read.delim("../Data/AdmixtureGraphs/AdmixGraphsBaseGraph.tsv")
graph2 <- read.delim("../Data/AdmixtureGraphs/AdmixGraph1.tsv")
graph3 <- read.delim("../Data/AdmixtureGraphs/AdmixGraph2.tsv")
graph4 <- read.delim("../Data/AdmixtureGraphs/AdmixGraph3BestFit.tsv")
graph5 <- read.delim("../Data/AdmixtureGraphs/AdmixGraph3Competing.tsv")
graph6 <- read.delim("../Data/AdmixtureGraphs/AdmixGraph4BestFit.tsv")
